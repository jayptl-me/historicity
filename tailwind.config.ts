...
export default {
	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				'parchment': '0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)',
				'antique': '0 4px 6px -1px rgba(139, 69, 19, 0.1), 0 2px 4px -1px rgba(139, 69, 19, 0.06)',
			},
		}
	},
